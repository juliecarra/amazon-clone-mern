          ...
          <div class="row">
            <div class="col-lg-4 col-md-5 col-sm-12">
              ...
              {/* <div class="cr-widget-histogram">
                ...
                <div class="row a-histogrm-row" style={{ marginTop: "-15px" }}>
                  <div class="col-md-2 col-sm-2 col-2 pr-0">
                    <div class="aok-nowrap">
                      <a href="#">4 star</a>
                      <span class="a-letter-space"></span>
              ...
              <div class="a-row">
                ...
                <span class="a-button-base writeReviewButton cm-cr-button-wide">
                  <span class="a-button-inner">
                    <Link to={`/reviews/${product._id}`} class="a-button-text">
            ...
            <div class="col-lg-6 col-md-7 col-sm-12">
              ...
              <div class="cr-widget-focalreviews">
                <div class="card-padding">
                  <div class="review-header">
                    <h3>
                      <span class="a-size-base">
                        {/* Showing 1-8 of {product.reviews.length} reviews */}
                      </span>
                    </h3>
                  </div>
                  ...
                  {/* <!-- Reviews --> */}
                  {reviews.map(review => (
                    <div class="review-body" key={review._id}>
                      ...
                      <div class="review-data">
                        ...
                        ></div>
                        <span class="avp-badge a-color-state">
                          Verified Purchase
                        </span>
                      </div>
                      {/* <!-- Review Body --> */}
